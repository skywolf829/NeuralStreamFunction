...
--save_name isabel_parallel_large \
...
python -u Code/train.py --n_outputs 2 --n_dims 3 \
--signal_file_name isabel.h5 \
--save_name isabel_parallel_small \
