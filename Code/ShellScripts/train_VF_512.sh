...
--save_name isotropic_coarse_vf_512_4x128 \
...
--save_name isotropic_coarse_vf_512_6x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_512_8x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:0 --data_device cuda:0 &
...
--save_name isotropic_coarse_vf_512_10x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:4 --data_device cuda:4 &
