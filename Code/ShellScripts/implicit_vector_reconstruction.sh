...
--save_name implicit_vector_reconstruction_synthetic1 \
...
--save_name implicit_vector_reconstruction_synthetic2 \
--n_layers 4 --nodes_per_layer 128 \
--residual false \
--points_per_iteration 200000 \
--iterations 10000 \
...
--save_name implicit_vector_reconstruction_synthetic3 \
--n_layers 4 --nodes_per_layer 128 \
--residual false \
--points_per_iteration 200000 \
--iterations 10000 \
...
--save_name implicit_vector_reconstruction_tornado \
--n_layers 4 --nodes_per_layer 128 \
--residual false \
--points_per_iteration 200000 \
--iterations 10000 \
...
--save_name implicit_vector_reconstruction_isabel \
...
--save_name implicit_vector_reconstruction_plume \
