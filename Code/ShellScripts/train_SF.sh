...
--save_name isotropic_coarse_mag_4x128 \
...
--save_name isotropic_coarse_mag_4x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_mag_4x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_mag_4x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_mag_6x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_mag_6x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_mag_6x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_mag_6x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_mag_8x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:0 --data_device cuda:0 &
...
--save_name isotropic_coarse_mag_8x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:1 --data_device cuda:1 &
...
--save_name isotropic_coarse_mag_8x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:2 --data_device cuda:2 &
...
--save_name isotropic_coarse_mag_8x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:3 --data_device cuda:3 &
...
--save_name isotropic_coarse_mag_10x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:4 --data_device cuda:4 &
...
--save_name isotropic_coarse_mag_10x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:5 --data_device cuda:5 &
...
--save_name isotropic_coarse_mag_10x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:6 --data_device cuda:6 &
...
--save_name isotropic_coarse_mag_10x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:7 --data_device cuda:7
