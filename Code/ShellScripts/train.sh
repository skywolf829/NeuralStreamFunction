...
python -u Code/train.py --n_outputs 2 --n_dims 3 \
--signal_file_name tornado3d.h5 \
--save_name tornado_parallel_small \
--n_layers 4 --nodes_per_layer 128 \
--points_per_iteration 200000 \
--iterations 10000 \
--fit_gradient false \
