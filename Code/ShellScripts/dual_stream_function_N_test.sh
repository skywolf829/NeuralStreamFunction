...
--save_name N_dual_streamfunction_vortices \
...
--save_name N_dual_streamfunction_flow_past_cylinder \
--n_layers 4 --nodes_per_layer 128 \
--points_per_iteration 100000 \
--iterations 10000 \
--dual_stream_function N \
...
--save_name N_dual_streamfunction_ABC_flow \
--n_layers 4 --nodes_per_layer 128 \
--points_per_iteration 100000 \
--iterations 10000 \
--dual_stream_function N \
...
--save_name N_dual_streamfunction_tornado3d \
--n_layers 4 --nodes_per_layer 128 \
--points_per_iteration 100000 \
--iterations 10000 \
--dual_stream_function N \
...
--save_name N_dual_streamfunction_isabel \
--n_layers 4 --nodes_per_layer 128 \
--points_per_iteration 100000 \
--iterations 10000 \
--dual_stream_function N \
...
--save_name N_dual_streamfunction_plume \
--n_layers 4 --nodes_per_layer 128 \
--points_per_iteration 100000 \
--iterations 10000 \
--dual_stream_function N \
