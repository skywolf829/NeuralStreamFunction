...
--save_name isotropic_coarse_vf_4x128 \
...
--save_name isotropic_coarse_vf_4x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_4x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_4x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_6x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_6x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_6x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_6x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
...
--save_name isotropic_coarse_vf_8x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:0 --data_device cuda:0 &
...
--save_name isotropic_coarse_vf_8x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:1 --data_device cuda:1 &
...
--save_name isotropic_coarse_vf_8x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:2 --data_device cuda:2 &
...
--save_name isotropic_coarse_vf_8x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:3 --data_device cuda:3 &
...
--save_name isotropic_coarse_vf_10x128 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:4 --data_device cuda:4 &
...
--save_name isotropic_coarse_vf_10x256 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:5 --data_device cuda:5 &
...
--save_name isotropic_coarse_vf_10x512 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:6 --data_device cuda:6 &
...
--save_name isotropic_coarse_vf_10x1024 \
--points_per_iteration 200000 \
--log_image false --log_gradient false \
--device cuda:7 --data_device cuda:7
